...
As of today, this repo contains work on Quantopo's first proof-of-concept with a continuous-variable quantum architecture model of integrated photonic circuits (under projects/QGLM/Xanadu) and data-driven quantum circuit learning with Rigetti's quantum backend (under projects/DDQCL/Rigetti). Proprietary algorithms are developed in-house. Other quantum algorithms under research and development will be released periodically.
